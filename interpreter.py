...
# for CLI usage, see https://github.com/SakuraaDev/TuringMachineInterpreter README.md. if you want to use this without a CLI, paste your machine path in place of str(sys.argv[1])
